...
def _get_provider_instance(provider: str, model: str) -> "BaseProvider":
    ...
    if provider == Provider.OPENAI:
        ...
        config = OpenAIConfig(openai_api_key=api_key)
        ...
        config = OpenAIConfig(
            openai_api_key=os.environ.get(AZURE_OPENAI_API_KEY_ENV_VAR),
            openai_api_type="azure",
            openai_api_base=os.environ.get(AZURE_OPENAI_ENDPOINT_ENV_VAR),
            openai_api_version=os.environ.get(AZURE_OPENAI_API_VERSION_ENV_VAR),
